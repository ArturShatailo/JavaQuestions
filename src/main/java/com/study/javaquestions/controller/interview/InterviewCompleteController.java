...
import com.study.javaquestions.service.actionHandlers.passInterview.InterviewCompleteServiceBean;
import lombok.AllArgsConstructor;
import org.springframework.stereotype.Component;

@Component
@AllArgsConstructor
public class InterviewCompleteController implements ActionHandler {

    private final InterviewCompleteServiceBean serviceBean;
