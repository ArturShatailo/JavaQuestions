...
import com.study.javaquestions.service.actionHandlers.addQuestions.SetQuestionAnswerServiceBean;
import lombok.AllArgsConstructor;
import org.springframework.stereotype.Component;

@Component
@AllArgsConstructor
public class SetQuestionAnswerController implements ActionHandler {

    private final SetQuestionAnswerServiceBean serviceBean;
