...
import com.study.javaquestions.service.actionHandlers.addQuestions.CreateNewQuestionServiceBean;
import lombok.AllArgsConstructor;
import org.springframework.stereotype.Component;

@Component
@AllArgsConstructor
public class CreateNewQuestionController implements ActionHandler {

    private final CreateNewQuestionServiceBean serviceBean;
